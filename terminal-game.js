...
class TerminalGame {
    ...
    initialize() {
        ...
        this.running = true;
        this.addMessage('Welcome to Pirate Sea! Use WASD to move, Q to quit.');
        this.render();
    }
    ...
    toggleMode() {
        ...
        if (this.player.mode === 'foot' && tile.biome === 'ocean') {
            this.player.mode = 'ship';
            this.addMessage('You board a ship!');
            ...
            this.addMessage('Cannot board ship from land!');
        }
    }
